(function() {
    ...
    A.ui.suggestion._Suggestion = function(F, B) {
        ...
        E._adjustPos = function(S) {
            ...
            J.style.top = L[0] - V + 7 + "px";
            J.style.left = L[1] - R - 7 + "px";
			J.style.zIndex = "100";
			if (A.ie && document.compatMode == "BackCompat") {
				J.style.width = L[2] + 13 + "px"
				J.style.left = L[1] - R - 6 + "px";
            } else {
        ...
        E._draw = function(M, T) {
            ...
            for (var O = 0,J = T.length; O < J; O++) {
                ...
                K.innerHTML = "<div style='padding-left:5px;' class='fuck_886404'>"+T[O]+"</div>";
            }
